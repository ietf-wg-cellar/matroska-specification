...
To register a new Track Type in this registry, one needs an Track Type value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#track-type-registry-table) is "IETF".
...
Note that the Change Controller for all entries in (#tags-target-registry-table) is "IETF".
...
Note that the Change Controller for all entries in (#alpha-mode-registry-table) is "IETF".
...
To register a new Content Encoding Scope in this registry, one needs an Content Encoding Scope value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#content-encoding-scope-registry-table) is "IETF".
...
To register a new Content Encoding Type in this registry, one needs an Content Encoding Type value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#content-encoding-type-registry-table) is "IETF".
...
To register a new Compression Algorithm in this registry, one needs an Compression Algorithm value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#compression-algorithm-registry-table) is "IETF".
...
Note that the Change Controller for all entries in (#encryption-algorithm-registry-table) is "IETF".
...
Note that the Change Controller for all entries in (#aes-cipher-mode-registry-table) is "IETF".
...
To register a new Stereo Mode in this registry, one needs an Stereo Mode value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#stereo-mode-registry-table) is "IETF".
...
To register a new Display Unit in this registry, one needs an Display Unit value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#display-unit-registry-table) is "IETF".
...
To register a new Projection Type in this registry, one needs an Projection Type value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#projection-type-registry-table) is "IETF".
...
To register a new Track Plane Type in this registry, one needs an Track Plane Type value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#track-plane-type-registry-table) is "IETF".
...
To register a new Horizontal Chroma Siting in this registry, one needs an Horizontal Chroma Siting value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#horizontal-chroma-siting-registry-table) is "IETF".
...
To register a new Vertical Chroma Siting in this registry, one needs an Vertical Chroma Siting value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#vertical-chroma-siting-registry-table) is "IETF".
...
To register a new Color Range in this registry, one needs an Color Range value,
description, a Change Controller (IETF or email of registrant), and
...
Note that the Change Controller for all entries in (#color-range-registry-table) is "IETF".
