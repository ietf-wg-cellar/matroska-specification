...
To display it differently for another local, applications **MUST** support auto
replacement on display.

For legacy reasons, it is possible that the "," separator **MAY** have been used
or that thousandths separators **MAY** have been used.
