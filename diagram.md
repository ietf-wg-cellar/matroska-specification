...
etc. `Tags` can contain their values in multiple languages. For example, a movie's "TITLE" `Tag` might contain both the original English title as well as the German title.
