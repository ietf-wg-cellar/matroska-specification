...
draft-lhomme-cellar-matroska-00.html: index.md
	...
	cat rfc_frontmatter.md "$<" matroska_schema_section_header.md ebml_matroska_elements4rfc.md notes.md order_guidelines.md codec_specs.md chapters.md subtitles.md tagging.md cover_art.md streaming.md menu.md | grep -v '^layout:\|^---\b' > merged.md
