VERSION_MATROSKA := 24
VERSION_MATROSKA_NEXT := 00
VERSION_CODEC := 19
VERSION_TAGS := 25
VERSION_CHAPTER_CODECS := 06
VERSION_CONTROL := 06
OUTPUT_MATROSKA := draft-ietf-cellar-matroska-$(VERSION_MATROSKA)
OUTPUT_MATROSKA_NEXT := draft-ietf-cellar-matroskanext-$(VERSION_MATROSKA_NEXT)
...
OUTPUT_CONTROL := draft-ietf-cellar-control-$(VERSION_CONTROL)
...
cellar-matroska-next/matroskanext_elements.md: transforms/ebml_schema2markdown4rfc5.xsl matroska_xsd.xml
...
cellar-matroska-next/matroskanext_iana_ids.md: transforms/ebml_schema2markdown4iana_ids5.xsl matroska_xsd.xml
